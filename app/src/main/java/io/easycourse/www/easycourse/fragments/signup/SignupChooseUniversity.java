...
public class SignupChooseUniversity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(io.easycourse.www.easycourse.R.layout.signup_choose_university, container, false);

        uniLayoutManager = new LinearLayoutManager(getContext());
        uniLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);

        uniRecyclerView = (RecyclerView) v.findViewById(io.easycourse.www.easycourse.R.id.choose_university_recycler_view);
        uniRecyclerView.setLayoutManager(uniLayoutManager);
        uniRecyclerView.setAdapter(uniAdapter);

        nextButton = (Button) v.findViewById(io.easycourse.www.easycourse.R.id.buttonChooseUniversityNext);
    ...
    public void gotoSignupChooseCourses() {
        ...
        transaction.replace(io.easycourse.www.easycourse.R.id.activity_signuplogin_container, SignupChooseCourses.newInstance());
