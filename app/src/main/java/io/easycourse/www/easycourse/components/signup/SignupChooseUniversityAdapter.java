...
public class SignupChooseUniversityAdapter extends RecyclerView.Adapter<SignupChooseUniversityAdapter.UniversityViewHolder> {
    ...
    static class UniversityViewHolder extends RecyclerView.ViewHolder {
        ...
        UniversityViewHolder(View itemView) {
            super(itemView);
            uniCardView = (CardView) itemView.findViewById(io.easycourse.www.easycourse.R.id.cardViewSingleItem);
            uniTextView = (TextView) itemView.findViewById(io.easycourse.www.easycourse.R.id.textViewSingleItem);
            uniCheckBox = (AnimateCheckBox) itemView.findViewById(io.easycourse.www.easycourse.R.id.checkBoxSingleItem);
            uniLayout = (RelativeLayout) itemView.findViewById(io.easycourse.www.easycourse.R.id.relativeLayoutSingleItem);
