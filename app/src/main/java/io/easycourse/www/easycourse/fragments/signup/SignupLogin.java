...
public class SignupLogin extends Fragment {
    ...
    @BindView(io.easycourse.www.easycourse.R.id.textViewTitle)
    TextView titleTextView;
    @BindView(io.easycourse.www.easycourse.R.id.editTextEmail)
    EditText emailEditText;
    @BindView(io.easycourse.www.easycourse.R.id.editTextPassword)
    EditText passwordEditText;
    @BindView(io.easycourse.www.easycourse.R.id.editTextVerifyPassword)
    EditText verifyPasswordEditText;
    @BindView(io.easycourse.www.easycourse.R.id.editTextUsername)
    EditText usernameEditText;

    @BindView(io.easycourse.www.easycourse.R.id.inputLayoutEmail)
    TextInputLayout emailInputLayout;
    @BindView(io.easycourse.www.easycourse.R.id.inputLayoutPassword)
    TextInputLayout passwordInputLayout;
    @BindView(io.easycourse.www.easycourse.R.id.inputLayoutVerifyPassword)
    TextInputLayout verifyPasswordInputLayout;
    @BindView(io.easycourse.www.easycourse.R.id.inputLayoutUsername)
    TextInputLayout usernameInputLayout;


    @BindView(io.easycourse.www.easycourse.R.id.buttonSignup)
    Button signupButton;
    @BindView(io.easycourse.www.easycourse.R.id.buttonLogin)
    Button loginButton;
    @BindView(io.easycourse.www.easycourse.R.id.fbThemeButton)
    Button facebookThemeButton;
    @BindView(io.easycourse.www.easycourse.R.id.buttonFacebookLogin)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(io.easycourse.www.easycourse.R.layout.signup_login, container, false);
        ...
        signupLinearLayout = (LinearLayout) v.findViewById(io.easycourse.www.easycourse.R.id.linearLayoutSignup);
        ...
        emailEditText.getBackground().setColorFilter(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorAccent), PorterDuff.Mode.SRC_IN);
        passwordEditText.getBackground().setColorFilter(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorAccent), PorterDuff.Mode.SRC_IN);
        verifyPasswordEditText.getBackground().setColorFilter(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorAccent), PorterDuff.Mode.SRC_IN);
        usernameEditText.getBackground().setColorFilter(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorAccent), PorterDuff.Mode.SRC_IN);

        // Change EditText text color
        emailEditText.setTextColor(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorWhiteText));
        passwordEditText.setTextColor(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorWhiteText));
        verifyPasswordEditText.setTextColor(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorWhiteText));
        usernameEditText.setTextColor(ContextCompat.getColor(getContext(), io.easycourse.www.easycourse.R.color.colorWhiteText));
        ...
        titleAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        emailAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        emailAnimEnter.setStartOffset(250);
        passwordAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        passwordAnimEnter.setStartOffset(250);
        verifyPasswordAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        verifyPasswordAnimEnter.setStartOffset(250);
        usernameAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        usernameAnimEnter.setStartOffset(250);
        loginAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        loginAnimEnter.setStartOffset(250 * 2);
        signupAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
        signupAnimEnter.setStartOffset(250 * 2);
        facebookAnimEnter = AnimationUtils.loadAnimation(getContext(), io.easycourse.www.easycourse.R.anim.fade_move_in);
    ...
    public void signup(View v) {
        ...
        if (verifyPasswordInputLayout.getVisibility() == View.GONE) {
            ...
            signupButton.setBackgroundResource(io.easycourse.www.easycourse.R.drawable.login_button);
            loginButton.setBackgroundResource(io.easycourse.www.easycourse.R.drawable.signup_button);
    ...
    public void emailLogin(final View v) {
        ...
        if (verifyPasswordInputLayout.getVisibility() == View.VISIBLE) {
            verifyPasswordInputLayout.setVisibility(View.GONE);
            usernameInputLayout.setVisibility(View.GONE);
            signupButton.setBackgroundResource(io.easycourse.www.easycourse.R.drawable.signup_button);
            loginButton.setBackgroundResource(io.easycourse.www.easycourse.R.drawable.login_button);
    ...
    public class SignupLoginTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            switch (view.getId()) {
                case io.easycourse.www.easycourse.R.id.editTextEmail:
                    validateEmail();
                    break;
                case io.easycourse.www.easycourse.R.id.editTextPassword:
                    validatePassword();
                    break;
                case io.easycourse.www.easycourse.R.id.editTextVerifyPassword:
                    validateVerifyPassword();
                    break;
                case io.easycourse.www.easycourse.R.id.editTextUsername:
                    validateUsername();
                    break;
            }
        }
