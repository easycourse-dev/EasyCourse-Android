...
public class UserProfileActivity extends AppCompatActivity {
    ...
    @BindView(io.easycourse.www.easycourse.R.id.toolbarUserProfile)
    Toolbar toolbar;
    @BindView(io.easycourse.www.easycourse.R.id.textViewUsername)
    TextView textViewUsername;
    @BindView(io.easycourse.www.easycourse.R.id.editTextUsername)
    EditText editTextUsername;
    @BindView(io.easycourse.www.easycourse.R.id.saveChangesButton)
    FloatingActionButton saveChangesButton;
    @BindView(io.easycourse.www.easycourse.R.id.editUsernameButton)
    ImageButton editUsernameButton;
    @BindView(io.easycourse.www.easycourse.R.id.editAvatarButton)
    FloatingActionButton editAvatarButton;
    @BindView(io.easycourse.www.easycourse.R.id.avatarImage)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.easycourse.www.easycourse.R.layout.activity_userprofile);
        ...
        try {
            ...
            Log.e("com.easycourse.www", currentUserObject.toString());
        ...
        saveChangesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("com.easycourse.www", user.getUsername());
                toggleProfileEdit();
            }
        });
    ...
    private void updateUserInfoOnScreen(){
        if (user.getProfilePicture() != null && user.getProfilePicture().length > 0) {
            ...
            avatarImage.setImageDrawable(getResources().getDrawable(io.easycourse.www.easycourse.R.drawable.ic_account_circle_black_48dp));
        }
    }
        ...
        try {
            APIFunctions.uploadImage(getApplicationContext(), new File(path), "test123", "avatar", "", new JsonHttpResponseHandler() {
                ...
                public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                    Log.e("com.easycourse.www", res.toString());
                }
            });
        } catch (JSONException e) {
            Log.e("com.easycourse.www", e.toString());
