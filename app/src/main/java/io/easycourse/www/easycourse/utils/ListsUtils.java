...
public class ListsUtils {
    ...
    public static boolean isCourseJoined(RealmResults<io.easycourse.www.easycourse.models.main.Course> joinedCourse, String course) {
    ...
    public static io.easycourse.www.easycourse.models.signup.Course isCourseJoined(ArrayList<io.easycourse.www.easycourse.models.signup.Course> joinedCourse, String course) {
        for (int i = 0; i < joinedCourse.size(); i++) {
            if (joinedCourse.get(i).getId().equals(course)) {
