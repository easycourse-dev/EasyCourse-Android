...
public class CourseDetailsRoomsRecyclerViewAdapter extends RecyclerView.Adapter<CourseDetailsRoomsRecyclerViewAdapter.RoomViewHolder> {
    ...
    public RoomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(io.easycourse.www.easycourse.R.layout.activity_course_details_room_item, viewGroup, false);
    ...
    public void onBindViewHolder(final RoomViewHolder holder, int i) {
        ...
        if (room.getFounder() != null && room.getFounder().getUsername() != null) {
            ...
            holder.founderImageView.setImageResource(io.easycourse.www.easycourse.R.drawable.ic_group_black_24px);
        }
    ...
    public class RoomViewHolder extends RecyclerView.ViewHolder {
        @BindView(io.easycourse.www.easycourse.R.id.CourseDetailsRoomName)
        TextView roomNameTextView;
        @BindView(io.easycourse.www.easycourse.R.id.CourseDetailsRoomDesc)
        TextView roomDescTextView;
        @BindView(io.easycourse.www.easycourse.R.id.CourseDetailsFounderImage)
        ImageView founderImageView;
        @BindView(io.easycourse.www.easycourse.R.id.CourseDetailsRoomFounder)
        TextView founderTextView;
        @BindView(io.easycourse.www.easycourse.R.id.CourseDetailsCheckbox)
