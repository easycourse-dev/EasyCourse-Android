...
public class SignupChooseLanguageAdapter extends RecyclerView.Adapter<SignupChooseLanguageAdapter.LanguageViewHolder> {
    ...
    static class LanguageViewHolder extends RecyclerView.ViewHolder {
        ...
        LanguageViewHolder(View itemView) {
            super(itemView);
            languageCardView = (CardView) itemView.findViewById(io.easycourse.www.easycourse.R.id.cardViewSingleItem);
            languageTextView = (TextView) itemView.findViewById(io.easycourse.www.easycourse.R.id.textViewSingleItem);
            languageCheckBox = (AnimateCheckBox) itemView.findViewById(io.easycourse.www.easycourse.R.id.checkBoxSingleItem);
            languageLayout = (RelativeLayout) itemView.findViewById(io.easycourse.www.easycourse.R.id.relativeLayoutSingleItem);
    ...
    public LanguageViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(io.easycourse.www.easycourse.R.layout.signup_choose_single_item, viewGroup, false);
