...
public class NewRoomCoursesAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflater.inflate(io.easycourse.www.easycourse.R.layout.activity_new_room_courses_item, null);
        TextView courseName = (TextView) view.findViewById(io.easycourse.www.easycourse.R.id.new_room_course_course_text);
        TextView titleName = (TextView) view.findViewById(io.easycourse.www.easycourse.R.id.new_room_course_title_text);
