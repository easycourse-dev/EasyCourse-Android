...
public class ChatImageViewFragment extends Fragment {
    ...
    @BindView(io.easycourse.www.easycourse.R.id.relative_layout_chat_image)
    RelativeLayout relativeLayout;
    @BindView(io.easycourse.www.easycourse.R.id.chatImageView)
    ImageView chatImageView;
    @BindView(io.easycourse.www.easycourse.R.id.chatImageProgressBar)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(io.easycourse.www.easycourse.R.layout.fragment_chat_image_view, container, false);
