...
public class UserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(io.easycourse.www.easycourse.R.layout.fragment_user, container, false);

        textViewUsername = (TextView) v.findViewById(io.easycourse.www.easycourse.R.id.textViewUsername);
        avatarImage = (ImageView) v.findViewById(io.easycourse.www.easycourse.R.id.avatarImage);
        cardProfile = (RelativeLayout) v.findViewById(io.easycourse.www.easycourse.R.id.cardUserProfile);
        cardCourses = (RelativeLayout) v.findViewById(io.easycourse.www.easycourse.R.id.UserFragmentCourseManageView);
        joinUsCard = (RelativeLayout) v.findViewById(io.easycourse.www.easycourse.R.id.joinUsCard);
        courseManageCard = (CardView) v.findViewById(io.easycourse.www.easycourse.R.id.UserFragmentCourseManageCard);
        ...
        if (user.getProfilePicture() != null) {
            ...
            avatarImage.setImageDrawable(ResourcesCompat.getDrawable(getResources(), io.easycourse.www.easycourse.R.drawable.ic_account_circle_black_48dp, null));
        }

        logoutButton = (Button) v.findViewById(io.easycourse.www.easycourse.R.id.buttonLogout);
