...
import io.easycourse.www.easycourse.components.signup.SignupChooseLanguageAdapter;
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        io.easycourse.www.easycourse.models.main.Language.updateLanguageToRealm(
                                new io.easycourse.www.easycourse.models.main.Language(
    ...
    public void postSignupData(UserSetup userSetup) {
        try {
            ...
            for (int i = 0; i < chosenLanguages.size(); i++) {
                io.easycourse.www.easycourse.models.main.Language.getLanguageByCode(chosenLanguages.get(i).getCode(), tempRealm).setChecked(true);
            }
            ...
            // Language handling
            ArrayList<String> languageCodes = ListsUtils.stringArrayToArrayList(userSetup.getLanguageCodeArray());
            for (int i = 0; i < languageCodes.size(); i++) {
                io.easycourse.www.easycourse.models.main.Language.getLanguageByCode(languageCodes.get(i), tempRealm).setChecked(true, tempRealm);
            }
