...
public class CourseManagementCoursesRecyclerViewAdapter extends RecyclerView.Adapter<CourseManagementCoursesRecyclerViewAdapter.CourseViewHolder> {
    ...
    static class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        CourseViewHolder(View itemView) {
            super(itemView);
            courseHolder = (RelativeLayout) itemView.findViewById(io.easycourse.www.easycourse.R.id.course_holder_layout);
            courseCardView = (CardView) itemView.findViewById(io.easycourse.www.easycourse.R.id.course_card_view);
            nameTextView = (TextView) itemView.findViewById(io.easycourse.www.easycourse.R.id.name_text);
            titleTextView = (TextView) itemView.findViewById(io.easycourse.www.easycourse.R.id.title_text);
            courseCheckBox = (AnimateCheckBox) itemView.findViewById(io.easycourse.www.easycourse.R.id.course_check_box);
    ...
    public CourseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(io.easycourse.www.easycourse.R.layout.signup_choose_courses_item, viewGroup, false);
